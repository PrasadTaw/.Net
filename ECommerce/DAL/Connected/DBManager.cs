...
public class DBManager{
    ...
    public static Department GetDeparmentDetails(int id){
     ...
     public static bool Insert(Department dept){
        ...
        //insert into departments (name, location) values( 'tanisha');
...
*/
    ...
    public static bool Insert(Employee emp)         //insertion of employee table data 
    {
        ...
        {
            con.Open();
            string query = "Insert into employees (Id, FirstName,LastName) Values( "+emp.Id+",'" + emp.FirstName + "','"
            + emp.LastName + "')";
            MySqlCommand cmd = new MySqlCommand(query, con);
    ...
    public static bool Update(Employee emp)           //updating employee table data 
    {
        ...
        try
        {
            string query = "Update employees SET firstName ='" + emp.FirstName + "'," + "lastName ='" + emp.LastName + " WHERE id =" + emp.Id;
